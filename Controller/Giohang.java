...
public class Giohang {
    ...
    //    String email = "trannhatlong.16072005@gmail.com";
    //    String title ="Có người đặt hàng";
    //    String noidung="Đã có người đặt hàng vui lòng kiểm tra đơn hàng để chốt đơn nhanh chóng còn có tiền mà sài mã đơn hàng là:" +order.getId();
    //    sendEmail.sendEmail(email, title, noidung);
    }
        return "redirect:/Giohang";
    }
